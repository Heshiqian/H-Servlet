...
public class FileAcceptFactory {
    ...
    public void doAccept(HttpServletRequest request) throws FileUploadException, IOException {
    ...
    public File getTarget(){
        if(target==null||!target.exists())
            throw new cn.heshiqian.framework.h.servlet.exception.FileUploadException("文件上传好像出了点问题");
        return target;
    }
